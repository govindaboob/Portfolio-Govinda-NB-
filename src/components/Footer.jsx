...
const socialLinks = [
  ...
  { 
    name: 'LinkedIn', 
    href: 'https://linkedin.com/in/govinda-boob', 
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  { 
    name: 'Twitter', 
    href: 'https://twitter.com/govindaboob', 
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="delay-300">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <a href="mailto:govinda.boob@example.com" className="font-mono text-gray-300 hover:text-white transition-colors text-sm">
                    govinda.boob@example.com
                  </a>
                </div>
